      ...
      <Ctn style={{ padding: "44px 28px" }}>
        <div style={{ maxWidth: 840, margin: "0 auto" }}>
          <div style={{ display: "flex", gap: 3, background: c.mtBg, borderRadius: 12, padding: 3, marginBottom: 28 }}>
            {[
              { id: "performance", l: "Performance", icon: <BarChart3 size={16} /> },
              { id: "profile", l: "Logic Profile", icon: <Brain size={16} /> },
            ].map((t) => (
              ...
              }}><span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>{t.icon} {t.l}</span></div>
            ))}
          </div>
            ...
            <div className="s1">
              ...
              {!tot && (
                <Card style={{ textAlign: "center", padding: 44 }}>
                  <div style={{ marginBottom: 10, display: "flex", justifyContent: "center" }}><TrendingUp size={36} color={c.mt} /></div>

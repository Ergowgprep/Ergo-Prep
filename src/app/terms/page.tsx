  ...
  return (
    <div style={{ minHeight: "100vh", background: c.bg, color: c.fg, fontFamily: fonts.b, transition: "background .4s, color .4s" }}>
      ...
      <Ctn style={{ padding: "60px 28px", maxWidth: 640 }}>
        <h1 className="s1" style={{ fontFamily: fonts.d, fontSize: 34, fontStyle: "italic", marginBottom: 22 }}>Terms of Service</h1>
        <div className="s2" style={{ color: c.fgS, lineHeight: 1.9, fontSize: 14.5 }}>
          <p style={{ marginBottom: 14 }}>Placeholder for the terms of service of the Ergo platform. Full legal text would appear here in production.</p>
